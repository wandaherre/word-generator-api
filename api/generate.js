...
// - Source: Label aus URL (Forbes/CFR/…) + Hyperlink
...
function deriveExercises(payload){
  // Help-Links: alle Varianten spiegeln - OHNE das falsche Override
